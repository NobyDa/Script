...
更新时间: 2020.8.16 8:00 v1.42 (Beta)
有效接口: 29+
...
async function all() {
  ...
  if (stop == 0) {
    ...
    await Promise.all([
      JDUserSignPre(stop, 'JDJewel', '京东商城-夺宝'), //京东夺宝岛
    ...
    await JDUserSignPre(stop, 'JDJewel', '京东商城-夺宝'); //京东夺宝岛
...
function initial() {
  ...
  acData = {
    // 京东商城-夺宝
    JDJewel: '29xMZdGiiGYmMZ5CQcGmb7iPhN7n',
    // 京东商城-母婴
