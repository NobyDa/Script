...
*/
var tasks = ['b6e688905d4e7184', 'a7f02e895ccbf416', '8ba31f70013989a8'] //浏览任务号
      ...
      if (error) {
        ...
        if (obj.code === "A00000") {
          if (obj.data.code === "A0000") {
            ...
            CheckinMsg = `签到成功: 获得积分${quantity}, 累计签到${continued}天 🎉`;
          } else {
            CheckinMsg = `签到失败: ${obj.data.msg} ⚠️`;
          }
        } else {
          CheckinMsg = `签到失败: Cookie无效 ⚠️`;
        }
      }
